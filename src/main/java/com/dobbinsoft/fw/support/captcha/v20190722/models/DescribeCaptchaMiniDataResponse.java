...
public class DescribeCaptchaMiniDataResponse extends AbstractModel {
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public DescribeCaptchaMiniDataResponse() {
    }
     ...
     */
    public DescribeCaptchaMiniDataResponse(DescribeCaptchaMiniDataResponse source) {
